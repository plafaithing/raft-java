...
echo "Manual Leader Election Test"
echo "==========================="

# 获取当前leader
echo "Getting current leader..."
current_leader=$(timeout 10 java -cp env/client/lib/*:target/classes com.github.wenweihu86.raft.example.client.GetLeader 127.0.0.1:8051 2>/dev/null | grep "127.0.0.1:" | head -1)
...
new_leader=$(timeout 10 java -cp env/client/lib/*:target/classes com.github.wenweihu86.raft.example.client.GetLeader 127.0.0.1:8051 2>/dev/null | grep "127.0.0.1:" | head -1)
